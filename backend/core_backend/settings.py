...
SECRET_KEY = 'django-insecure-7pv=jz^6yw6dg-3ddn@7!%a-c!w_8g6t+n)ui&g=vta4^99r3&'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # MUST sit at the absolute top boundary
